...
st.title("Welcome to Agriculture Image Classifier Web App!")#change according to your project   #edit 3
...
with tab2:
  ...
  pdf_url = "https://raw.githubusercontent.com/chkvk509/AP_AI_CLUB/main/sample.pdf"
