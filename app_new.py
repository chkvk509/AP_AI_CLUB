...
PREDICTED_LABELS = ["jute","maize","rice","sugarcane","wheat"]
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/b05e8632-6c28-4ea7-8694-520689a93a90'  #Edit 2-- get endpoint URL from navigator by deploying your onnx model
...
st.title("Welcome to Agriculture Crops Image Classifier Web App!")#change according to your project   #edit 3
...
with tab1:
  #setting up the title
  st.header("Agriculture Image Classifier")#change according to your project   #Edit 3
...
with tab2:
  ...
  st.link_button("My Github Repository", "https://github.com/chkvk509/AP_AI_CLUB") #Edit 4
  ...
  pdf_url = "https://raw.githubusercontent.com/chkvk509/AP_AI_CLUB/main/myreport.pdf"
